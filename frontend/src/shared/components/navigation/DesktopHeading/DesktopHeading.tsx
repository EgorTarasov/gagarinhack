  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden="true"
      />
      <aside className="hidden sm:flex fixed left-0 bottom-0 top-0 w-[190px] desktop:w-[300px] flex-col px-2 desktop:px-4 py-8 gap-4">
        <Logo className="w-3/4 max-w-[100px]" />
        <nav className="flex-1 h-full flex flex-col overflow-y-hidden overflow-x-visible w-full">
          <ul className="flex flex-col gap-1 overflow-y-auto overflow-x-visible">
            {RoutesStore.routes
